...
public class AddCarPolicyScreenController {
        ...
        public void addPolicy(javafx.scene.input.MouseEvent mouseEvent) {
            ...
            String queryCars = "INSERT INTO " + dbConnection.tableNameCars + "(registrationNr, nrPolicy, mark, model) VALUES (?,?,?,?)";
            PreparedStatement preparedStatement = null;

            try {
                preparedStatement = dbConnection.connection.prepareStatement(queryStandard);
                ...
                preparedStatement = dbConnection.connection.prepareStatement(queryCars);
                preparedStatement.setString(1,registrationNr.getText().toString().trim());
                preparedStatement.setString(2,nrPolicy.getText().toString().trim());
                preparedStatement.setString(3,mark.getText().toString().trim());
